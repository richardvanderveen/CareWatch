...
function calendar(date) {
  ...
  calendar_html +='<tr><td colspan="7" style="background-color:black; color:white; text-align: center;">' + months[month] + ' ' + year + '</td></tr>';
  calendar_html +='<tr>';
  ...
  document.getElementById('calendar_block').innerHTML = calendar_html;
}
