...
/*	//Controleerd of velden leeg zijn, zo ja ga terug naar login scherm*/
	if (empty($uid) || empty($pwd))
		...
		{
			$sql = "SELECT * FROM nawa WHERE nawa_username='$uid'";//SQL opdracht zoeken e-mail in tabel
			...
			$hash = $row['nawa_password'];//Zet gehashed wachtwoord van gevonden gebruiker uit DB in variabele $hash
